''' Here, the MHIST dataset is resized to 224, saved in rgb, grayscale, sparsity on rgb, and sparsity on grayscale. All modes will be saved in png files'''
...
base_path = '/work/deogun/alali/data/mhist_gs'
out_path = '/work/deogun/alali/data/mhist_gs_sp'
